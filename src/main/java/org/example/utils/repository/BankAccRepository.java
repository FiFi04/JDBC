...
@Data
public abstract class BankAccRepository<T extends BankAcc<E>, E> implements Repository<T, E> {
    ...
    public void save(T object) {
        ...
        try (Statement statement = connection.createStatement()) {
            ...
            while (idSet.next()) {
                if (object.getId() != null && object.getId().equals(idSet.getObject(BankAcc.ID))) {
    ...
    private String getInsertValue(Field objectField, T object) throws IllegalAccessException, ClassNotFoundException,
        ...
        if (className.startsWith("org.example") && !objectField.getType().isEnum()) {
            BankAcc fieldObject = (BankAcc) objectField.get(object);
            ...
            if (id != null) {
                ...
                BankAccRepository repository = (BankAccRepository) repositoryConstructor.newInstance();
                repository.depthLevel = depthLevel + 1;
    ...
    private <T extends BankAcc<E>> void updateObject(T object, String insertValues, String insertColumns, Statement statement, String tableName) throws SQLException {
    ...
    private Object fetchObject(Field field, E object) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        Constructor<?> repositoryConstructor = newRepository.getConstructor();
        Method findById = newRepository.getMethod("findById", Object.class);
        findById.setAccessible(true);
        Optional newObjectOptional = (Optional) findById.invoke(repositoryConstructor.newInstance(), object);
